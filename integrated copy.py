...
def myODE(init,t,params):
    ...
    dHog1P2nuc = vHog1P2trans*(Vcyt/Vnuc) - vHog1deph
    ...
    return (dSln1, dSln1P, dYpd1, dYpd1P, dSsk1, dSsk1P, dSsk2, dSsk2P, dPbs2, dPbs2P, dPbs2P2, dHog1, dHog1P, dHog1P2cyt, dHog1P2nuc, dHog1nuc, dmRNAnuc1, dmRNAcyt1, dProtein1, dGluc, dG6P, dFBP, dGAP, dDHAP, dPyr, dG3P, dGlycin, dGlycex, dNADH, dNADp, dATP, dADP, Protein1_0, dPIi, dc, dVos)
