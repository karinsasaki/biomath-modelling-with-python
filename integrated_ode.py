...
def myODE(init,t,params):
    ...
    # **********
        ...
        # phosphorelay module
    dSln1 = -v1TCS + v2TCS - Sln1*Vratio 
    dSln1P = v1TCS - v2TCS - Sln1P*Vratio
    dYpd1 = -v2TCS + v2TCS - Ypd1*Vratio
    dYpd1P = v2TCS - v3TCS - Ypd1P*Vratio
    dSsk1 = -v3TCS + v4TCS - Ssk1*Vratio
    dSsk1P = v3TCS - v4TCS - Ssk1P*Vratio
